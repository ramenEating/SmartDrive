...
public class Mypage_sub_account extends AppCompatActivity{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.mypage_sub_account_ui);
            ...
            String title = intent.getExtras().getString("key2");
            ...
            mTextView.setText("연동 정보/로그인/로그아웃");
